...
\end{bmatrix} \, .
\end{align} 
We may also denote the left product $\H^{\otimes2}$ and the right product $\ket{0}\ket{0}$ or $\ket{00}$. Letting $\ket{10}$, $\ket{01}$ and $\ket{11}$ take on analogous meanings, an immediate result of Equation \eqref{eq:twoqubits} is that
...
\begin{align}
\H^{\otimes n} \ket{0} = \frac{1}{\sqrt{N}}\Big(\ket{0} + \ket{1} + \dots + \ket{N-1}\Big) =  \frac{1}{\sqrt{N}} \sum_{x=0}^{N-1} \ket{x} \, .
\end{align}
...
\section{Quantum parallelism, search and minimization}
