...
\end{align}
and the many-qubit analogue for Equation \eqref{eq:quantparallel} is
...
\begin{align*}
 \left(\frac{1}{\sqrt{N}} \sum_{x=0}^{N-1} \ket{x} \right)  \frac{1}{\sqrt{2}}\left(\ket{0} -\ket{1}\right) =  \frac{1}{\sqrt{N}} \sum_{x=0}^{N-1} \ket{x} \ket{-} \, .
\end{align*}
...
\end{align*}
Finally, the action of $\U_{x_0}$ on the superposition takes the form
\begin{align*}
